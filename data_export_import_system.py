                        ...
                        for idx, row in df.iterrows():
                            ...
                            if idx > 0:
                                ...
                                trade_data.append({
                                    ...
                                    'amount': row['volume'] / 1000,  # Scale down volume
                                    'price': current_close,
                                    'profit': price_change * (row['volume'] / 1000),
                                    'commission': current_close * (row['volume'] / 1000) * 0.001,  # 0.1% commission
                                    'status': 'completed',
                                    'strategy': 'production_data',
                                    'data_source': 'production_api' if not use_testnet else 'testnet_api'
                                })
